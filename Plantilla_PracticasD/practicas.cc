...
void funcion_idle() {
   if( escena != NULL ) {
      escena->animacionesColoresLucesMateriales();
      escena->animarModeloJerarquico();
      escena->animacionesVarias();
   }
   glutPostRedisplay();
}
...
int main( int argc, char **argv )
{
   ...
   glutCreateWindow("Practicas IG: Diego Velázquez Ortuño");
   ...
   // "seed" the random number generator by calling srand()
